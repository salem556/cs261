...
/*
*this function checks if the given linked list is empty.
* it returns 1 if the list is empty, 0 if not.
* Params:
 *   list - the linked list into which to insert an element. 
*/
...
/*
*this function gets the element at the top of the stack and returns it 
* Params:
 *   stack - the stack of which we're getting the top elemnt from
...
*this function removes the element at the top of the stack and returns it 
* Params:
 *   stack- 
...
/*
 * This function returns the value stored at the front of a given linked list
 * without removing that value.
 *
 * Params:
 *   list - the linked list from which to get the front value.  May not be NULL.
 *
 * Returns:
 *   The value stored at the front of the list, or NULL if the list is empty.
 */
...
/*
 * This function removes the element at the front of a given linked list and
 * returns the value stored in that element.
 *
 * Params:
 *   list - the linked list from which to remove the front element.  May not be NULL.
 *
 * Returns:
 *   The value stored in the element that was removed from the front of the list,
 ...
 *
 * Params:
 *   list - the linked list whose size is to be determined. May not be NULL.
 *
 * Returns:
